...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Batch.submitted'
        db.add_column('gallery_batch', 'submitted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Batch.submitted'
        db.delete_column('gallery_batch', 'submitted')
