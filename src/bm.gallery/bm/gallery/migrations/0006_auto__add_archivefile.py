...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gallery_archivefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('filefield', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='archives', null=True, to=orm['gallery.Batch'])),
        ))
        db.send_create_signal('gallery', ['ArchiveFile'])


    def backwards(self, orm):
        
        # Deleting model 'ArchiveFile'
        db.delete_table('gallery_archivefile')
    ...
    models = {
        ...
        'gallery.archivefile': {
            'Meta': {'object_name': 'ArchiveFile'},
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'archives'", 'null': 'True', 'to': "orm['gallery.Batch']"}),
